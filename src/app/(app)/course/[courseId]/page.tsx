    ...
    <>
                ...
                <Card.Root className="bg-[#363636]">
                  <Card.Body className="p-4">
                    <div className="flex flex-col gap-6">
                      ...
                      <span
                        onClick={open}
                        className="absolute bottom-4 text-base right-2 text-zinc-400 hover:text-zinc-50 cursor-pointer px-2 bg-[#363636]"
                      >
                        ...Ver mais
                      </span>
                    </div>
      ...
      <Modal.Root isOpen={opened} onClose={close}>
        <Modal.Content className="h-full">
          <p className="text-base max-w-[700px]">{course.data.description}</p>
        </Modal.Content>
      </Modal.Root>
    </>
  );
