      ...
      <div className="relative  flex-col items-start bg-amber-200 dark:bg-amber-950 dark:bg-grid-small-white/[0.2]  bg-dot-black/[0.2]  rounded-xl max-h-[343px] min-h-[340px]">
        <div className="py-16 px-10 space-y-2 max-w-[70%]">
          ...
          <div className="flex gap-3 py-2">
            <Tag name={`${courses.data[courses.data.length -2].chapters.length} Modulos`} className="bg-zinc-50/70" startContent={<IconNotebook  className="w-5 h-5 text-zinc-500 dark:text-zinc-400"/>}  />
        ...
        <Image src={courses.data[courses.data.length -2].imageUrl || ''} className="rounded-xl w-[313px] max-h-[176px] object-cover"  alt="course" width={313} height={176}  unoptimized />
