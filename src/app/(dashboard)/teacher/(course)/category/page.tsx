        ...
        <table className="w-full text-sm text-left rtl:text-right text-zinc-500 dark:text-zinc-400">
          ...
          <tbody>
            <tr className="bg-zinc-50 border-b dark:bg-zinc-950 dark:border-zinc-900 py-2">
              ...
              <td className="px-6 py-4">Em 23 cursos</td>
        ...
        >
          <div className="flex flex-col gap-3 p-4">
            ...
            <div className="flex flex-col gap-4">
              <input
                className="max-h-12 text-sm w-full p-6 rounded-lg focus:ring-0 outline-none bg-zinc-100 hover:bg-white focus:bg-white dark:bg-zinc-900 dark:hover:bg-zinc-800/30 dark:focus:bg-zinc-800/30"
                type="text"
                name="title"
              ...
              <div className="flex justify-end gap-2">
                ...
                <button className="p-2 items-center justify-center text-zinc-100 flex rounded-md gap-2 text-xs bg-[#015F43] hover:bg-[#224138]  disabled:bg-[#172d26]">
                  {" "}
                  <span className="">Adicionar categoria</span>
                </button>
              </div>
            </div>
          </div>
