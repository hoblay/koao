...
,[courseId ]) 
  ...
  return (
    <div className="max-w-[546px] relative max-h-[310px]">
      {imageUrl || image !== null 
        ? <Image src={image?.preview ? image.preview : imageUrl ?  imageUrl : '' } className="rounded-xl object-cover min-h-[310px] max-h-[310px]" width={546} height={408} alt="course" unoptimized /> 
